...
public class ModBlocks {
    ...
    public static final Block RENDIUM_ORE = new BlockRendiumOre(WeirdThings.MODID, "rendium_ore", WeirdThings.TAB, 4, 9, Material.ROCK, SoundType.STONE, MapColor.SAND, 2, ModToolTypes.PICKAXE, 3.0f, 3.0f, 4);
