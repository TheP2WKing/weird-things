...
public class LayerWitherGirlAura implements LayerRenderer<EntityWitherGirl> {
	private static final ResourceLocation WITHER_ARMOR = new ResourceLocation(
			"textures/entity/wither/wither_armor.png");
	private final RenderWitherGirl witherRenderer;
	private final ModelWitherGirl witherModel = new ModelWitherGirl(0.5F);

	public LayerWitherGirlAura(RenderWitherGirl witherRendererIn) {
		this.witherRenderer = witherRendererIn;
	}

	@Override
	public void doRenderLayer(EntityWitherGirl entitylivingbaseIn, float limbSwing, float limbSwingAmount,
