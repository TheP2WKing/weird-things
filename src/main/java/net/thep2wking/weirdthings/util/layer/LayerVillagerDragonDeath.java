...
public class LayerVillagerDragonDeath implements LayerRenderer<EntityVillagerDragon> {
	@Override
	public void doRenderLayer(EntityVillagerDragon entitylivingbaseIn, float limbSwing, float limbSwingAmount,
		...
		if (entitylivingbaseIn.deathTicks > 0) {
			...
			for (int i = 0; (float) i < (f + f * f) / 2.0F * 60.0F; ++i) {
				...
				bufferbuilder.pos(-0.866D * (double) f3, (double) f2, (double) (-0.5F * f3)).color(255, 0, 255, 0)
						.endVertex();
				bufferbuilder.pos(0.866D * (double) f3, (double) f2, (double) (-0.5F * f3)).color(255, 0, 255, 0)
						.endVertex();
