...
public class LayerFlowerPigFlower implements LayerRenderer<EntityFlowerPig> {
	private final RenderFlowerPig mooshroomRenderer;

	public LayerFlowerPigFlower(RenderFlowerPig mooshroomRendererIn) {
