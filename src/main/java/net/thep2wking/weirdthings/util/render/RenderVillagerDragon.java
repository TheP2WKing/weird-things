...
import net.thep2wking.weirdthings.content.model.ModelVillagerDragon;
import net.thep2wking.weirdthings.util.layer.LayerVillagerDragonDeath;
import net.thep2wking.weirdthings.util.layer.LayerVillagerDragonEyes;
