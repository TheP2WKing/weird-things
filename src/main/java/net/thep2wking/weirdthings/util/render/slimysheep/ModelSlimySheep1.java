...
public class ModelSlimySheep1 extends ModelQuadruped {
	private float headRotationAngleX;

	public ModelSlimySheep1() {
		super(12, 0.0F);
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount,
		...
		this.head.rotationPointY = 6.0F
				+ ((EntitySlimySheep) entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 9.0F;
		this.headRotationAngleX = ((EntitySlimySheep) entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
	}
