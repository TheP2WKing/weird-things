package net.thep2wking.weirdthings.util.render.villagerblaze;
...
public class ModelVillagerBlaze extends ModelBlaze {
    private ModelRenderer[] blazeSticks = new ModelRenderer[12];
    private ModelRenderer blazeHead;
    private ModelRenderer nose;

	public ModelVillagerBlaze() {
		textureWidth = 64;
		textureHeight = 32;
        ...
        this.blazeHead = new ModelRenderer((ModelBase)this, 32, 0);
        this.blazeHead.addBox(-4.0f, -4f, -4.0f, 8, 10, 8);
        this.nose = new ModelRenderer((ModelBase)this, 56, 0);
        this.nose.addBox(-1.0f, 3.0f, -6.0f, 2, 4, 2);
        this.nose.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.blazeHead.addChild(this.nose);
	}
