package net.thep2wking.weirdthings.util.render.creeperchicken;
...
public class LayerCreeperChickenCharge implements LayerRenderer<EntityCreeperChicken> {
	...
	public LayerCreeperChickenCharge(RenderCreeperChicken creeperRendererIn) {
