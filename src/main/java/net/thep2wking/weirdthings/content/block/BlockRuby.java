...
public class BlockRuby extends ModBlockBase {

	public BlockRuby(String modid, String name, CreativeTabs tab, Material material, SoundType sound, MapColor mapColor,
