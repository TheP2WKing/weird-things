...
public class BlockChickenLeaves extends ModBlockLeavesBase {
	public BlockChickenLeaves(String modid, String name, CreativeTabs tab, Material material, SoundType sound,
	...
	public ItemStack dropSapling() {
		return new ItemStack(ModBlocks.CHICKEN_SAPLING, 1, 0);
	}
