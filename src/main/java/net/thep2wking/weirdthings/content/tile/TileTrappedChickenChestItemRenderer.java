...
public class TileTrappedChickenChestItemRenderer extends TileEntityItemStackRenderer {
	...
	public static void registerTEISRModel(Item item) {
		...
		TileTrappedChickenChestItemRenderer TEISR = new TileTrappedChickenChestItemRenderer();
